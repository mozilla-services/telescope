...
HISTORY_PROJECT_ID = config("HISTORY_PROJECT_ID", default=None)
...
LIMIT_REQUEST_CONCURRENCY = config("LIMIT_REQUEST_CONCURRENCY", default=4, cast=int)
LIMIT_WORKER_CONCURRENCY = config("LIMIT_WORKER_CONCURRENCY", default=8, cast=int)
...
WARM_CACHE_ON_STARTUP = config("WARM_CACHE_ON_STARTUP", default=True, cast=bool)
