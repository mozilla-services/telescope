...
INFLUXDB_ORG = config("INFLUXDB_ORG", default=SERVICE_NAME)
INFLUXDB_BUCKET = config("INFLUXDB_BUCKET", default=SERVICE_NAME)
INFLUXDB_TIMEOUT_SECONDS = config("INFLUXDB_TIMEOUT_SECONDS", default=0.3, cast=float)
